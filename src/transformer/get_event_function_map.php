...
function get_event_function_map() {
    ...
    // If you plan on using an omitted event, make sure to update the corresponding test.php in tests
        ...
        '\core\event\course_created' => 'core\course_created', // Update Mofa database
        ...
        '\core\event\user_updated' => 'core\user_updated', // Update Mofa database
        ...
        '\mod_quiz\event\attempt_submitted' => 'mod_quiz\attempt_submitted\handler', // Feedback assistant
